...
<footer class="bg-black text-white rounded-t-3xl snap-always snap-center font-body">
    <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-start space-y-6 md:space-y-0 py-24">
        ...
        <a href="index.php" class="flex-shrink-0">
            <img class="h-10 rounded-xl" src="<?= $result[0]["image"]?>" alt="Logo">
        </a>

        <div class="w-full md:w-1/3">
            <h3 class="text-white text-xl mb-4">Snelle Links</h3>
            <ul class="space-y-2">
                <li><a href="./index.php" class="text-blue-400 hover:underline">Home</a></li>
                <li><a href="./spiegelspel.php" class="text-blue-400 hover:underline">Spiegelspelconcept</a></li>
                <li><a href="./dienst.php" class="text-blue-400 hover:underline">Dienstregeling</a></li>
                <li><a href="./contact.php" class="text-blue-400 hover:underline">Contact</a></li>
        ...
        <div class="w-full md:w-1/3">
            ...
            <ul class="space-y-4">
                ...
                <li>
                    <div class="flex space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 192 192" fill="none">
                        ...
                        <a href="http://spiegelspel.nl" class="text-blue-400 hover:underline ">Spiegelspel.nl</a>
                    </div>
                </li>
        </div>
        </ul>
