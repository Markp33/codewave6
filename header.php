        ...
        <div class="container mx-auto flex items-center justify-between p-4">
            ...
            <nav id="menu" class="hidden md:flex md:items-center space-x-4">
                <ul class="flex flex-col md:flex-row md:space-x-4">
                    ...
                    <li><a href="dienst.php" class=" hover:text-black border-l border-white pl-4">Dienstregeling</a>
                    </li>
            ...
            <nav id="dropdownMenu"
                class="hidden absolute top-16 left-4 right-4 bg-white text-gray-800 rounded-lg shadow-lg md:hidden">
